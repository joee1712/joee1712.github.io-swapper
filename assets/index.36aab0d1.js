...
class K {
  constructor(e) {
    const t =
      "random" === e.shader || Array.isArray(e.shader)
        ? R(e.shader, e)
        : G[e.shader];
    (this.shader = t),
  ...
  animateUniform(e, t, n) {
    ...
    const r = t > e.value ? "next" : "prev",
      ...
      l = () => {
        ...
        let m = o + c * (t - o);
        if ((a(m, t) && (m = t), (e.value = m), a(m, t)))
          return (
            cancelAnimationFrame(this.animateUniformFrame), void (n && n())
          );
  ...
  loadTextures() {
    ...
    return (
      (this.swiper && this.swiper.isElement
        ...
        .querySelectorAll(".swiper-gl-image")
        .forEach((e) => {
  ...
  createMaterial() {
    return new h(
      ...
      ((e, s) => {
        ...
        if (t) for (var r of t(s)) o.call(s, r) && i(e, r, s[r]);
        return e;
      })(
        {
          extensions: {
  ...
  addObjects() {
    if (
      ...
      const e = (function (e, t, n) {
          ...
          for (let r = 0; r < a; r += 1) {
            ...
            for (let e = 0; e <= o; e += 1) {
              ...
              const U = f(v / 2 + (2 * y) / t);
              let E = Math.random();
              l.push(U, f(U + 0.1 * n), f(U + 0.1 * n)), g.push(E, E, E);
          ...
          const y = new r(e);
          return (
            y.addAttribute("position", { size: 3, data: new Float32Array(c) }),
            y.addAttribute("bary", { size: 3, data: new Float32Array(u) }),
            y.addAttribute("uv", { size: 2, data: new Float32Array(x) }),
            y.addAttribute("offset", { size: 1, data: new Float32Array(l) }),
            y.addAttribute("centroid1", { size: 3, data: new Float32Array(m) }),
            y.addAttribute("control0", { size: 3, data: new Float32Array(h) }),
            y.addAttribute("control1", { size: 3, data: new Float32Array(p) }),
            y.addAttribute("random", { size: 1, data: new Float32Array(g) }),
            y
          );
      ...
      (this.plane = new g(this.gl, { geometry: e, program: this.material })),
  ...
  replaceShader(e) {
    let t, n;
    this.shader.vertex
      ? ((t = this.material.uniforms.texture1.value),
        (n = this.vertexMaterial.uniforms.texture1.value))
      : ((t = this.material.uniforms.texture1.value),
  ...
  setProgress(e, t, n, o, i) {
    ...
    this.swiper.params.loop &&
      this.swiper.slides[e] &&
      this.swiper.slides[t] &&
      ((e = parseInt(
        this.swiper.slides[e].getAttribute("data-swiper-slide-index"),
        10
      )),
      (t = parseInt(
        this.swiper.slides[t].getAttribute("data-swiper-slide-index"),
        10
      )));
    ...
    if (
      ...
      this.shader.vertex
        ? (this.vertexMaterial.uniforms.texture1.value = s)
...
const I = new d(".swiper", {
    modules: [
      u,
      function ({ swiper: e, on: t, extendParams: n }) {
        e.gl = null;
        let o = !1;
        n({
          gl: { shader: "random", shaderPerSlide: !1, displacementMap: void 0 },
        });
        const i = () => {
          e.gl = new K({
            swiper: e,
        ...
        t("beforeInit", () => {
          ...
          t("slidesGridLengthChange", () => {
            "gl" !== e.params.effect ||
              ...
              !e.initialized ||
              e.glDestroyed ||
              (e.gl && e.gl.loadTextures && e.gl.loadTextures());
          }),
          t("beforeDestroy", () => {
            "gl" !== e.params.effect ||
              o ||
              (e.gl && ((e.glDestroyed = !0), e.gl.destroy(), (e.gl = null)));
          });
      },
    ],
    speed: 1e3,
...
document
  ...
  .addEventListener("click", () => {
    T.style.display =
      "none" !== T.style.display && T.style.display ? "none" : "block";
  }),
